...
Devise.setup do |config|
  ...
  config.mailer_sender = "saitai@example.com"
  ...
  # config.pepper = "b9337f125389ccea3f309551b69254847740db33b1f1438439fe048dc162b90d5648185635e80f265fa185c003f8da5c546ab876aa16c0017421c701ab83b57d"
  ...
  config.omniauth :twitter, API_KEY['twitter']['consumer_key'], API_KEY['twitter']['consumer_secret']
  config.omniauth :facebook, API_KEY['facebook']['app_id'], API_KEY['facebook']['app_secret']
...
#    :idp_cert                       => "-----BEGIN CERTIFICATE-----\n...-----END CERTIFICATE-----", # idp_cert_fingerprintと排他指定のため不要
  ...
  {
    :host => API_KEY['ldap']['host'],
    :port => API_KEY['ldap']['port'],
    :method => :plain,
    :base => API_KEY['ldap']['base_dn'],
    :uid => API_KEY['ldap']['uid_key'],
#    :name_proc => Proc.new {|name| name.gsub(/@.*$/,'')},
    :bind_dn => API_KEY['ldap']['bind_dn'],
    :password => API_KEY['ldap']['admin_password'],
  }
